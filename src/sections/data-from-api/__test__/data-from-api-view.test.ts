...
describe("Migrate Data From API : ", () => {
  it("it should migrate work", () => {
    const expectedResult: TResult = {
      Engineering: {
        male: 0,
        female: 1,
        ageRange: "28-28",
  ...
  it("it should add user data to department", () => {
    const result = addUserDataToDepartment(mockDataFromApi[0], {
      male: 0,
      female: 0,
      ageRange: `${mockDataFromApi[0].age}-${mockDataFromApi[0].age}`,
      hair: {},
      addressUser: {},
    });
